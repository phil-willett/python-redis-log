...
class RedisLogRecord(logging.LogRecord):
    def __init__(self, name, lvl, fn, lno, dur, msg, args, exc_info, func=None, extra=None):
        logging.LogRecord.__init__(self, name, lvl, fn, lno, dur, msg, args, exc_info, func)
...
class RedisLogger(logging.getLoggerClass()):
    def makeRecord(self, name, lvl, fn, lno, dur, msg, args, exc_info, func=None, extra=None):
        record = RedisLogRecord(name, lvl, fn, lno, dur, msg, args, exc_info, func=None)
